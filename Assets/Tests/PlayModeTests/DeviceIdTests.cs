...
namespace Assets.Tests.PlayModeTests
{
    public class DeviceIdTests
    {
        ...
        [TestCase(DeviceIdType.DeveloperProvided, "", DeviceIdType.DeveloperProvided, false)]
        [TestCase(DeviceIdType.DeveloperProvided, null, DeviceIdType.DeveloperProvided, false)]
        [TestCase(DeviceIdType.DeveloperProvided, " ", DeviceIdType.DeveloperProvided, false)]
        [TestCase(DeviceIdType.DeveloperProvided, "new_user", DeviceIdType.DeveloperProvided, true)]
        [TestCase(DeviceIdType.SDKGenerated, "", DeviceIdType.SDKGenerated, false)]
        [TestCase(DeviceIdType.SDKGenerated, null, DeviceIdType.SDKGenerated, false)]
        [TestCase(DeviceIdType.SDKGenerated, " ", DeviceIdType.SDKGenerated, false)]
        [TestCase(DeviceIdType.SDKGenerated, "new_user", DeviceIdType.DeveloperProvided, true)]
        public void SetId(DeviceIdType startingType, string id, DeviceIdType expectedIdType, bool isExpectingChange)
        {
        ...
        [TestCase(DeviceIdType.SDKGenerated)]
        [TestCase(DeviceIdType.DeveloperProvided)]
        public void SetId_SameId(DeviceIdType startType)
        {
            string deviceId;
            DeviceIdType currentType;
            if (startType == DeviceIdType.SDKGenerated) {
                Countly.Instance.Init(new CountlyConfiguration(_appKey, _serverUrl));
                currentType = DeviceIdType.SDKGenerated;
            } else {
                Countly.Instance.Init(TestUtility.CreateBaseConfig());
                currentType = DeviceIdType.DeveloperProvided;
            }
            deviceId = Countly.Instance.Device.DeviceId;
