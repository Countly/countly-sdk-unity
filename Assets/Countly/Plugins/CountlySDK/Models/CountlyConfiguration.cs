...
namespace Plugins.CountlySDK.Models
{
    ...
    public class CountlyConfiguration
    {
        ...
        /// </summary>
        private bool EnableConsoleLogging = false;
        /// <summary>
        /// Set mode of push notification.
        /// </summary>
        private TestMode NotificationMode = TestMode.None;
        /// <summary>
        /// Set to true to enable manual session handling.
        /// </summary>
        private readonly bool EnableManualSessionHandling = false;
        /// <summary>
        ...
        {
            return $"{nameof(ServerUrl)}: {ServerUrl}, {nameof(AppKey)}: {AppKey}, {nameof(DeviceId)}: {DeviceId}, {nameof(EnableConsoleLogging)}: {EnableConsoleLogging}, {nameof(EventQueueThreshold)}: {EventQueueThreshold}, {nameof(StoredRequestLimit)}: {StoredRequestLimit}";
        }
        ...
        #region Setters
        internal void SetServerUrl(string serverUrl)
        {
